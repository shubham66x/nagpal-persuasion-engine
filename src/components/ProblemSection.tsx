...
const problems = [
  { icon: HeartCrack, title: "Medical Emergency?", desc: "One hospital visit can wipe out years of savings. Average ICU costs ₹50,000/day in Punjab." },
    ...
    <div className="container-narrow">
      <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
        ...
        <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
          Most families in Ludhiana & Punjab are dangerously underinsured. One unexpected event can undo a lifetime of hard work.
        </p>
      </motion.div>
      ...
      <div className="grid sm:grid-cols-2 gap-6">
        {problems.map((p, i) => (
          ...
          >
            <div className="w-12 h-12 rounded-lg bg-warm/10 flex items-center justify-center mb-4">
