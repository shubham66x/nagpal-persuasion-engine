    ...
    <div className="flex items-center gap-3">
      ...
      >
        <svg
          ...
          className="w-full h-full drop-shadow-[0_0_8px_hsl(45_90%_60%/0.5)]"
        >
          <defs>
          ...
          {/* Outer shield */}
          <path
            d="M32 4 L56 14 L56 32 C56 46 45 56 32 60 C19 56 8 46 8 32 L8 14 Z"
            fill="url(#shieldDark)"
          ...
          {/* Inner gold accent */}
          <path
            d="M32 12 L48 19 L48 32 C48 42 41 49 32 52 C23 49 16 42 16 32 L16 19 Z"
            fill="url(#shieldGold)"
            opacity="0.15"
          />
          {/* Monogram N */}
      ...
      <div className="flex flex-col leading-none">
        <span className={`font-heading font-bold tracking-wide ${sizes.title} ${titleColor}`}>
          Nagpal <span className="text-gradient-gold animate-heading-glow">Insurance</span>
        </span>
